...
<head>
    ...
    <script type="text/javascript">
        function setFormat(id) {
            let value = document.getElementById(id).value.replace(/[^\d]/g, ''); // Remove non-numeric characters
            value = Number(value).toLocaleString(); // Format as number with commas
...
<body>
                ...
                <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card">
                        <div class="card-header text-center">
                            <h2>Add Revenue Account</h2>
                        </div>
                        <div class="card-body p-4 p-sm-5">
                            <form id="bankRevenueForm" action="add_revenue_account_process.php" method="post">
                                ...
                                <div class="mb-3"><input class="form-control" type="text" placeholder="Type" value="Receiveable" disabled /></div>
        ...
        <div class="body-main">
            <div class="row flex-center min-vh-100 my-5 justify-content-center">
                <div class="col-sm-10 col-md-8">
                    <div class="card" style="border-radius: 2rem;background-color:#f1f6fb;">
                        <div class="text-center" style="margin-top: 30px;background-color: #0097b2;color:#fff;">
                            <h2>รายรับ (Receivable)</h2>
                        </div>
                        <div class="card-body p-sm-5">
                            <form id="bankAccountForm" action="add_bank_account.php" method="post">
                                ...
                                <div class="mb-3"><input class="form-control" type="text" name="to_account_no" placeholder="รับเงินเข้าบัญชี xxxx-x (5 ตัวหลัง)" /></div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#bankRevenueForm").submit(function(e) {
                e.preventDefault();

                // Perform the form submission using AJAX
                $.ajax({
                    type: "POST",
                    url: "add_revenue_account_process.php", // Point this to the correct processing file
                    data: $("#bankRevenueForm").serialize(),
                    dataType: "json",
