...
<body>
                ...
                <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card">
                        <div class="card-header text-center">
                            <h2>Add Transfer Account</h2>
                        </div>
                        <div class="card-body p-4 p-sm-5">
                            <form id="bankTransferForm" action="add_transfer_account_process.php" method="post">
                                ...
                                <div class="mb-3"><input class="form-control" type="text" placeholder="Type" value="Transfer" disabled /></div>
        ...
        <div class="body-main">
            <div class="row flex-center min-vh-100 my-5 justify-content-center">
                <div class="col-sm-10 col-md-8">
                    <div class="card" style="border-radius: 2rem;background-color:#f2fadb;">
                        <div class="text-center" style="margin-top: 30px;background-color: #f5ad27;color:#fff;">
                            <h2>โอนเงิน (Transferable)</h2>
                        </div>
    ...
    <div class="col-5">
        <input class="form-control" type="text" name="account_from" placeholder="xxxx-x (5 ตัวหลัง)" />
    </div>
    <div class="col-2 d-flex align-items-center justify-content-center">
        <label class="mb-0">TO</label>
    </div>
    <div class="col-5">
        <input class="form-control" type="text" name="account_to" placeholder="xxxx-x (5 ตัวหลัง)" />
    </div>
</div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#bankTransferForm").submit(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "add_transfer_account_process.php", // Point this to the correct processing file
                    data: $("#bankTransferForm").serialize(),
                    dataType: "json",
